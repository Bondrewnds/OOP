...
public class DiemHocVien {
	...
	public String toString() {
		...
		return String.format(
				"Ho va ten: %-15s|Ngay sinh: %10s|Diem mon 1: %5s|Diem mon 2: %5s|Diem mon 3: %5s|Diem mon 4: %5s|Diem mon 5: %5s|DTB: %5s",
				name, dtf.format(dateOfB), diemMon1, diemMon2, diemMon3, diemMon4, diemMon5, getDTB());
	}
